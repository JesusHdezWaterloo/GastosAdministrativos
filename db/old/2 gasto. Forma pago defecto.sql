...
--
-- Host: 127.0.0.1:7733
-- Generation Time: Aug 21, 2020 at 10:54 PM
...
--
ALTER TABLE `gasto`
  ADD CONSTRAINT `FK_gasto_cuadre` FOREIGN KEY (`cuadre_fk`) REFERENCES `cuadre` (`id_cuadre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_gasto_moneda` FOREIGN KEY (`moneda_fk`) REFERENCES `moneda` (`id_moneda`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `tipo_gasto`
  ADD CONSTRAINT `FK_tipo_gasto_gorma_pago` FOREIGN KEY (`forma_pago_fk`) REFERENCES `forma_pago` (`id_forma_pago`) ON DELETE CASCADE ON UPDATE CASCADE,
